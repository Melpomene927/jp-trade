    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GUI', models.CharField(blank=True, max_length=20, null=True, verbose_name='統一編號')),
                ('email', models.CharField(blank=True, max_length=50, null=True, verbose_name='連絡Email')),
            ],
            options={
                'verbose_name': '註冊公司',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addressJP', models.CharField(blank=True, max_length=100, null=True, verbose_name='地址(日文)')),
                ('addressEN', models.CharField(blank=True, max_length=100, null=True, verbose_name='地址(英文)')),
                ('phone', models.CharField(blank=True, max_length=20, null=True, verbose_name='連絡電話')),
                ('FAX', models.CharField(blank=True, max_length=20, null=True, verbose_name='傳真號碼')),
                ('email', models.CharField(blank=True, max_length=50, null=True, verbose_name='連絡Email')),
            ],
            options={
                'verbose_name': '部門',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdon', models.DateTimeField(auto_now_add=True, verbose_name='建檔日期')),
                ('MAWB', models.CharField(blank=True, max_length=20, null=True, verbose_name='清關條碼 (MAWB)')),
                ('HAWB', models.CharField(blank=True, max_length=20, null=True, verbose_name='提單號 (HAWB)')),
                ...
                ('flight', models.CharField(blank=True, max_length=20, null=True, verbose_name='航班號碼')),
            ],
            options={
                'verbose_name': '發票(日本)',
                'ordering': ['number'],
        ...
        migrations.CreateModel(
            name='Package',
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='包裹唯一碼')),
