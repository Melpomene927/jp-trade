    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(max_length=50, null=True, verbose_name='連絡Email')),
            ],
            options={
                'verbose_name': '註冊公司',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdon', models.DateTimeField(auto_now_add=True, verbose_name='建檔日期')),
                ('MAWB', models.CharField(blank=True, max_length=20, verbose_name='清關條碼 (MAWB)')),
                ('HAWB', models.CharField(blank=True, max_length=20, verbose_name='提單號 (HAWB)')),
                ...
                ('flight', models.CharField(blank=True, max_length=20, verbose_name='航班號碼')),
            ],
            options={
                'verbose_name': '發票(日本)',
                'ordering': ['number'],
